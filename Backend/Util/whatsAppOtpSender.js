...
const otpStore = {}; // Store temporarily, replace with Redis/DB in production
...
export const sendOTPViaWhatsApp = async (phone) => {
  ...
  const otpValidity = "5 minutes";
  const otpSecurityNote = "Do not share this code with anyone. If you did not request it, please ignore this message.";

// Final message
const message = `${systemName} Verification\n\nYour One-Time Password (OTP) is: ${otp}\n\nThis code is valid for ${otpValidity}.\n${otpSecurityNote}`;
  // waclient.com API payload
